package com.isagod.util.wechat;
...
import com.isagod.dto.UserAccessToken;
import com.isagod.dto.WechatUser;
...
public class WechatUtil {
    ...
    public static UserAccessToken getUserAccessToken(String code) throws IOException {
        // 测试号信息里的appId
        String appId = "wx7d160fd8bd7e3d0b";
        log.debug("appId:" + appId);
        // 测试号信息里的appsecret
        String appsecret = "a486214a3d2ee1e6d06b446e01af54f4";
    ...
    /**
     * 将WechatUser里面的信息转化为PersonInfo信息并转入personInfo实体类
     * @param user
     * @return
     */
